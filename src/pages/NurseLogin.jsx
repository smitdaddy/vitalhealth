    ...
    <div className="clinical-gradient min-h-screen flex items-center justify-center p-gutter relative z-0">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md animate-in fade-in zoom-in duration-500">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="font-headline-md text-headline-md text-primary">Nurse Portal</h2>
          <p className="text-on-surface-variant text-sm mt-2">Sign in to access patient vitals and triage.</p>
        </div>
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="space-y-2">
            <label className="font-label-md text-on-surface-variant">Staff ID</label>
            <input type="text" required className="w-full bg-surface-container-low border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary rounded-xl py-3 px-4 outline-none transition-all" placeholder="Enter your ID" />
          </div>
          <div className="space-y-2">
          ...
          <button type="submit" className="w-full py-4 bg-primary text-on-primary rounded-full font-label-lg shadow-md hover:shadow-lg hover:opacity-90 active:scale-95 transition-all">
            Secure Login
          </button>
        </form>
